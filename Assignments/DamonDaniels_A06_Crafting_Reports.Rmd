...
```{r project.setup, message=FALSE, warning=FALSE, include=TRUE}
#Import libraries
library(tidyverse)
library(lubridate)
library(here)
...
```{r, fig.height = 3, fig.width = 5, echo=FALSE, message=FALSE, warning=FALSE, fig.cap= "2018 Monthly Ozone Levels"}
...
Ozone_By_Month_2018 <-
  ...
  labs(
    x = expression(Month),
    y = expression(Concentration~(μg/m^3)))
print(Ozone_By_Month_2018)

```

```{r, fig.height = 3, fig.width = 5, echo=FALSE, message=FALSE, warning=FALSE, fig.cap= "2019 Monthly Ozone Levels"}
